  ...
  return (
    <Stack
      ...
      sx={{
        ...
        transition: 'transition: transform 0.3s ease, border 0.3s ease',
        overflow: 'hidden',
        marginBottom: '120px',
      }}
    >
      <Stack width='45%' sx={{ overflowY: 'scroll', maxHeight: '340px', scrollbarWidth: 'none' }}>
        <AnimatedList
          sx={{
            display: 'flex',
            gap: '16px',
          ...
          {data.leftSider.lists.map((e, index) => {
            return (
              ...
              >
                ...
                <Typography className={nunitoSans.className} sx={{ fontSize: '14px', color: '#81868f', lineHeight: '1.2' }}>
                  {e.content}
                </Typography>
              </ListItem>
            );
      ...
      <Stack width='55%' display='flex'>
        <Typography sx={{ marginBottom: '8px', color: 'white' }}>{data.rightSide.name}</Typography>
        ...
        <Typography className={nunitoSans.className} sx={{ color: 'white' }} fontSize={16} lineHeight={1.4}>
