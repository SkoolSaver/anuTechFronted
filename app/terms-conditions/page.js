      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ p: 3, background: '#fff', borderRadius: 2 }}>
          <Typography variant="subtitle2" color="textSecondary">
            Last updated on 17-10-2025 11:53:53
          </Typography>

          <Typography paragraph mt={2}>
            These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding agreement by and between SKOOLSAVER PRIVATE LIMITED, ( “Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, “Services”).
          </Typography>
          ...
          {/* Contact button removed as per requirement */}
        </Box>
      </Container>
    </Box>
  );
